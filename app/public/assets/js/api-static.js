async function getData(city) {
   // console.log('url request: ' + `https://raw.githubusercontent.com/BogieBogard/US-Census-Data-Visualization/master/city-data/${city}.json`);
  try {
    const response = await axios.get(`https://raw.githubusercontent.com/BogieBogard/US-Census-Data-Visualization/master/city-data/${city}.json`);
...
$("#search-btn").on("click", async function () {
   ...
   // console.log(searchedCity);
    ...
    let data = await getData(updateComma(searchedCity));
